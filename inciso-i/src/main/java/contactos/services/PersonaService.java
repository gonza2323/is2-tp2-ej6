...
import contactos.repositories.ContactoCorreoElectronicoRepository;
import contactos.repositories.ContactoTelefonicoRepository;
import contactos.repositories.PersonaRepository;
...
public class PersonaService extends BaseService<Persona, String> {
    ...
    @Override
    protected void antesDeBaja(String id) throws ErrorServiceException {
        try {
